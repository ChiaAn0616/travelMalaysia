...
const placeholderTexts = [ 
    ...
    "Enter restaurant name, type, or location…",
    "Search for restaurants by name, cuisine, or area…",
    "Type to find restaurants, dishes, or dining spots…"
];
...
function filterEvents() {
    ...
    events.forEach(function(event) {
        ...
        const showEvent = matchesQuery && matchesState && matchesCategory && matchesPrice;
        if (showEvent) {
